...
const HomePage: React.FC = () => {
    ...
    const readData = async () => {
        try {
            const querySnapshot: any = await getDocs(collection(db, "images"));
            const dataList: any = [];
        ...
        <div id="container">
            {firstLoad ? (
                ...
                <>
                    ...
                    >
                        <div id="hero-heading" className="md:w-6/12">
                            ...
                            <p className="text-[12px] font-[100p] md:text-[20px] text-primary">
                                (Untuk Masa Depan Gemilang) - Universitas
                                Terbuka Purwokerto{" "}
                            </p>
                            <Link href="#history">
                    ...
                    >
                        ...
                        <div id="history-title" className="md:w-full">
                            ...
                            <p className="text-[12px] leading-5 text-gray-600 mt-3 text-justify md:text-lg">
                                Di Wilayah Sekitar POKJAR Gemilang, yang
                                Berlokasi di Jalan Kabupaten Menghubungkan
                                Kecamatan Kuwarasan, Adimulyo, Karanganyar,
                                Gombong, banyak terdapat Sekolah Lanjutan
                                Tingkat Atas. Mayoritas siswanya berasal dari
                                masyarakat petani dan pedagang. Setelah lulus
                                SLTA, banyak dari mereka bekerja di Kebumen atau
                                luar Kebumen. Beberapa juga bekerja di
                                pabrik-pabrik di sekitar wilayah, seperti Pabrik
                                Rokok Sampoerna, Pabrik Ternit, pengolahan kayu,
                                pabrik bata dan genteng, serta di supermarket
                                dan toko-toko di wilayahnya. Beberapa juga
                                bekerja di sektor perbankan seperti BCA, BSI,
                                BRI, Mandiri, BNI, Bank Jateng, Danamon, dll.
                                Dengan motivasi tinggi untuk melanjutkan kuliah,
                                UT menjadi solusi efisien bagi mereka. Oleh
                                karena itu, didirikanlah tempat layanan UT
                                Purwokerto. Oleh karena itu didirikanlah
                                KELOMPOK BELAJAR (POKJAR) UNIVERSITAS PURWOKERTO
                                di Kebumen dengan nama POKJAR GEMILANG pada
                                tanggal 1 Mei 2023 untuk memberi layanan bagi
                                mahasiswa, calon mahasiswa dan masyarakat luas
                                di kabupaten Kebumen dan juga luar kabupaten
                                Kebumen yang Membutuhkan.
                            </p>
                        </div>
                    </div>
                    <div
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <p>
                                        Menjadi Perguruan Tinggi Terbuka dan
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <p>
                                            Meningkatkan Daya Tampung Perguruan
                                            Tinggi Negeri
                                        </p>
                                    </div>
                                    <div
                                    ...
                                    >
                                        ...
                                        <p>
                                            Mendiseminasikan Hasil Kajian
                                            Keilmuan dan Pendidikan Jarak Jauh
                        ...
                        >
                            <div id="sipas">
                                ...
                                <p className="text-justify  md:text-base">
                                    Sipas adalah sistem pengambilan matakuliah
                                    yang dibuat dalam bentuk paket-paket
                                    semester. Sipas terdiri dari Sipas Non TTM,
                                    Sipas Semi, dan Sipas Penuh. Sipas Non TTM
                                    merupakan Sipas tanpa tutorial tatap muka,
                                    tutorial yang diberikan berupa Tutorial
                                    Online. Sipas Semi merupakan Sipas dengan
                                    tutorial tatap muka untuk setengah dari
                                    jumlah matakuliah yang ada dalam paket.
                                    Sipas Penuh merupakan Sipas dengan tutorial
                                    tatap muka untuk semua matakuliah yang ada
                                    dalam paket.
                                </p>
                            </div>
                            <div id="non-sipas">
                                ...
                                <p className="text-justify  md:text-base">
                                    ...
                                    matakuliah yang dilakukan secara bebas. oleh
                                    mahasiswa. Pemilihan matakuliah dapat
                                    berpedoman pada Katalog UT
                                </p>
                            </div>
                        </div>
                    </div>
                    <div
                        id="academik"
                        className="px-4 py-4 mt-4 bg-[#FAFAFA] md:p-8"
                    >
                        <p className="text-md font-semibold md:text-xl">
                            Akademik
                        </p>
                        ...
                        >
                            ...
                            <Link
                                href={"https://www.ut.ac.id/fhisip/"}
                                target="_blank"
                            >
                                <p className="bg-primary text-[12px] p-2 rounded-md text-white md:text-base">
                                    Fakultas Hukum, Ilmu Sosial, dan Ilmu Hukum
                                    ( FISHIP )
                                </p>
                            </Link>
                            <Link
                                href={"https://www.ut.ac.id/fkip/"}
                                target="_blank"
                            >
                                <p className="bg-primary text-[12px] p-2 rounded-md text-white md:text-base">
